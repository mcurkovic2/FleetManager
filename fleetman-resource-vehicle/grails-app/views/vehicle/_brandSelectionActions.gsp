<div>
	...
	<g:submitButton class="btn btn-purple"  name="newBrand" value="New Brand" value="${message(code:'newVehicle.brandSelection.newBrand.label')}"></g:submitButton>
<%--	<g:link action="newVehicle/brandSelection/cancel" >Cancel</g:link>--%>
