...
<div class="row">
	<div class="col-lg-12">
		<div class="alert alert-info alert-dismissable">
			<button aria-hidden="true" class="close" data-dismiss="alert" type="submit">&times;</button>
			We&#39;re using <a class="alert-link" href="http://tablesorter.com/docs/">Tablesorter 2.0</a> for the sort function on the tables. Read the documentation for
		...
		<div class="table-responsive">
			<table class="table table-bordered table-hover table-striped tablesorter">
				<thead>
					<tr>
						<th>
							${message(code: 'user.userId.label', default: 'User Id')} <i class="fa fa-sort"></i>
						</th>
						<th>
							${message(code: 'user.active.label', default: 'Active')}<i class="fa fa-sort"></i>
						</th>
						<th>
							${message(code: 'user.description.label', default: 'Description')} <i class="fa fa-sort"></i>
						</th>
						<th>
							${message(code: 'user.firstName.label', default: 'First Name')} <i class="fa fa-sort"></i>
						</th>
						<th>
							${message(code: 'user.lastName.label', default: 'Last Name')} <i class="fa fa-sort"></i>
						</th>
				</thead>
				<tbody>
